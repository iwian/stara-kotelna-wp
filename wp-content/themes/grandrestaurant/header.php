...
<?php
	...
	if(!function_exists( 'has_site_icon' ) || ! has_site_icon() ) 
	{
		...
		*	Get favicon URL
		**/
		$grandrestaurant_favicon = get_theme_mod('grandrestaurant_favicon');
		
		if(!empty($grandrestaurant_favicon))
		{
?>
			<link rel="shortcut icon" href="<?php echo esc_url($grandrestaurant_favicon); ?>" />
<?php
		}
	}
?>  
...
<body <?php body_class(); ?>>
	...
	<?php
		...
		$tg_page_title_img_blur = get_theme_mod('tg_page_title_img_blur', 1);
		...
		$pp_reservation_24hours = get_option('pp_reservation_24hours');
		
		//Get custom header & footer contents
		$grandrestaurant_header_content = get_theme_mod('grandrestaurant_header_content', 'menu');
		
		//Get lightbox options
		$tg_enable_theme_lightbox = get_theme_mod('tg_enable_theme_lightbox', 1);
		$tg_lightbox_thumbnails = get_theme_mod('tg_lightbox_thumbnails', 1);
		$tg_lightbox_enable_title = get_theme_mod('tg_lightbox_enable_title', 1);
	?>
	...
	<input type="hidden" id="pp_back" name="pp_back" value="<?php _e( 'Back', 'grandrestaurant' ); ?>"/>
	...
	<input type="hidden" id="pp_reservation_24hours" name="pp_reservation_24hours" value="<?php echo esc_attr($pp_reservation_24hours); ?>"/>
	<input type="hidden" id="grandrestaurant_header_content" name="grandrestaurant_header_content" value="<?php echo esc_attr($grandrestaurant_header_content); ?>"/>
	<input type="hidden" id="tg_enable_theme_lightbox" name="tg_enable_theme_lightbox" value="<?php echo esc_attr($tg_enable_theme_lightbox); ?>"/>
	<input type="hidden" id="tg_lightbox_thumbnails" name="tg_lightbox_thumbnails" value="<?php echo esc_attr($tg_lightbox_thumbnails); ?>"/>
	<input type="hidden" id="tg_lightbox_enable_title" name="tg_lightbox_enable_title" value="<?php echo esc_attr($tg_lightbox_enable_title); ?>"/>
	...
	<div class="mobile_menu_wrapper">
    	...
    	<form role="search" method="get" name="searchform" id="searchform" action="<?php echo home_url(); ?>/">
    	    <div>
    	    	<input type="text" value="<?php the_search_query(); ?>" name="s" id="s" autocomplete="off" placeholder="<?php _e( 'Search...', 'grandrestaurant' ); ?>"/>
    	    	<button>
		...
		?>
		<a href="<?php echo esc_attr($href_link); ?>" id="tg_sidemenu_reservation" class="button <?php echo esc_attr($class_name); ?>"><?php _e( 'Reservation', 'grandrestaurant' ); ?></a>
		<?php
		 }
		?>
		<!-- End Reservation -->
	...
	<div id="wrapper" <?php if(!empty($page_menu_transparent)) { ?>class="hasbg transparent"<?php } ?>>
	
	<?php
		$grandrestaurant_header_content = get_theme_mod('grandrestaurant_header_content', 'menu');
		
		//If display Elementor header layout
		if($grandrestaurant_header_content == 'content')
		{
			get_template_part("/templates/template-elementor-header");
		}
		//If display default menu layouts
		else
		{
	...
	?>
			...
			<?php
				$customizer_styling_arr = array( 
					array(
						...
						'url' => grandrestaurant_get_demo_url('/bistro', 'grandrestaurantv7-0'),
						'label' => 'New',
					),
					array(
						'id'	=>	18, 
						'title' => 'Cocktail & Bar', 
						'url' => grandrestaurant_get_demo_url('/bar', 'grandrestaurantv7-0'),
						'label' => 'New',
					),
					array(
						'id'	=>	17, 
						'title' => 'Sushi Restaurant', 
						'url' => grandrestaurant_get_demo_url('', 'grandrestaurantv7-0'),
						'label' => 'New',
					),
					array(
						'id'	=>	16, 
						'title' => 'Asian Restaurant', 
						'url' => grandrestaurant_get_demo_url('/asian', 'grandrestaurantv6-8'),
						'label' => 'New',
					),
					array(
						'id'	=>	15, 
						'title' => 'Steakhouse', 
						'url' => grandrestaurant_get_demo_url('/steak', 'grandrestaurantv6-8'),
						'label' => 'New',
					),
					array(
						'id'	=>	14, 
						'title' => 'Elegant Restaurant', 
						'url' => grandrestaurant_get_demo_url('', 'grandrestaurantv6-8'),
						'label' => 'New',
					),
					array(
						'id'	=>	13, 
						'title' => 'Fusion Restaurant', 
						'url' => grandrestaurant_get_demo_url('', 'grandrestaurantv6-7'),
					),
					array(
						'id'	=>	12, 
						'title' => 'Clean Food', 
						'url' => grandrestaurant_get_demo_url('/clean', 'grandrestaurantv6-7'),
					),
					array(
						'id'	=>	11, 
						'title' => 'Pizza Restaurant', 
						'url' => grandrestaurant_get_demo_url('/pizza', 'grandrestaurantv6-7'),
					),
					array(
						'id'	=>	10, 
						'title' => 'Asian Fusion', 
						'url' => grandrestaurant_get_demo_url('grandrestaurantv6/demo10'),
					),
					array(
						'id'	=>	9, 
						'title' => 'Fast Food & Burger', 
						'url' => grandrestaurant_get_demo_url('grandrestaurantv6/demo9'),
					),
					array(
						'id'	=>	8, 
						'title' => 'Traditional Restaurant', 
						'url' => grandrestaurant_get_demo_url('grandrestaurantv6/demo8'),
					),
					array(
						'id'	=>	1, 
						'title' => 'Main Demo', 
						'url' => grandrestaurant_get_demo_url('grandrestaurantv6'),
					),
					array(
						'id'	=>	6, 
						'title' => 'Luxury Restaurant', 
						'url' => grandrestaurant_get_demo_url('grandrestaurantv6/demo6'),
					),
					array(
						'id'	=>	2, 
						'title' => 'Chinese Restaurant', 
						'url' => grandrestaurant_get_demo_url('grandrestaurantv6/demo2'),
					),
					array(
						'id'	=>	7, 
						'title' => 'Italian Restaurant', 
						'url' => grandrestaurant_get_demo_url('grandrestaurantv6/demo7'),
					),
					array(
						'id'	=>	3, 
						'title' => 'Healthy Food', 
						'url' => grandrestaurant_get_demo_url('grandrestaurantv6/demo3'),
					),
					array(
						'id'	=>	4, 
						'title' => 'Left Menu Layout', 
						'url' => grandrestaurant_get_demo_url('grandrestaurantv6/demo4'),
					),
					array(
						'id'	=>	5, 
						'title' => 'Cafe & Bakery', 
						'url' => grandrestaurant_get_demo_url('grandrestaurantv6/demo5'),
					),
				);
			?>
	    	<ul class="demo_list">
	    ...
	    <div id="option_btn">
	    	...
	    	<a href="<?php echo grandrestaurant_get_demo_url('grandrestaurantv6/landing/showcase'); ?>" class="demotip" title="Showcase" target="_blank"><span class="ti-heart"></span></a>
	...
	<?php
	    	...
	    	wp_enqueue_script("script-demo", get_stylesheet_directory_uri()."/js/custom-demo.js", false, THEMEVERSION, true);
	    }
	?>