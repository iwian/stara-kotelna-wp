	...
	<div class="post_wrapper">
	    ...
	    <div class="post_content_wrapper">
		    ...
		    <?php
				...
				$tg_blog_header_bg = get_theme_mod('tg_blog_header_bg', 'blog_single');
		    ...
		    ?>
				    ...
				    <?php
				    	...
				    	$tg_blog_display_tags = get_theme_mod('tg_blog_display_tags', 'blog_single');
			...
			<?php
			    $tg_blog_display_related = get_theme_mod('tg_blog_display_related', 'blog_single');
			...
			if ($tags) {
			 ...
			 ?>
			 	<br class="clear"/><hr/><br/><br/>
			  	<h5 class="related_post"><span><?php echo _e( 'You might also like', 'grandrestaurant' ); ?></span></h5><br class="clear"/>
			...
			<?php
			    $tg_blog_display_author = get_theme_mod('tg_blog_display_author', 'blog_single');
			...
			<div id="about_the_author">
				<h3 class="about_author"><?php echo _e( 'About The Author', 'grandrestaurant' ); ?></h3><br/>
...
{
		if(!grandrestaurant_check_is_elementor()) {
?>
