...
if(!empty($tg_pages_template_404)) {
	...
	if (class_exists("\\Elementor\\Plugin")) {
		echo grandrestaurant_get_elementor_content($tg_pages_template_404);
	}
}
...
<div id="page_content_wrapper">
    ...
    <div class="inner">
    	...
    	<div class="inner_wrapper">
			...
			<p class="error_text"><?php _e( 'Not Found!', 'grandrestaurant' ); ?></p>
    	
	    	<div class="search_form_wrapper">
	    		<div class="content">
	    	    	<?php _e( "We're sorry, the page you have looked for does not exist in our content!", 'grandrestaurant' ); ?><br/>
	    	    	<?php _e( "Perhaps you would like to go to our homepage or try searching below.", 'grandrestaurant' ); ?>
	    		</div>
	    	    
	    	    <form class="searchform" role="search" method="get" action="<?php echo home_url(); ?>">
			    	<input style="width:100%" type="text" class="field searchform-s" name="s" value="<?php the_search_query(); ?>" placeholder="<?php _e( 'Type to search and hit enter...', 'grandrestaurant' ); ?>">
			    </form>
    		</div>
	    	
	    	<br/><hr/><br/><br/>
	    	
	    	<h5><?php _e( 'Or try to browse our latest posts instead?', 'grandrestaurant' ); ?></h5><br/><br/>
										...
										<div class="post_quote_title grid">
											...
											<div class="post_detail">
										    	...
										    	<?php
										    		...
										    		{
										    	?>
										    		<?php echo _e( 'In', 'grandrestaurant' ); ?>
										    	<?php
							    ...
							    <div class="post_header grid">
							    	...
							    	<div class="post_detail">
									    ...
									    <span class="post_readmore">
								            <a class="readmore" href="<?php the_permalink(); ?>"><?php echo _e( 'Read More', 'grandrestaurant' ); ?></a>
								        </span>
									</div>
							    </div>
						...
						?>
						    	    ...
						    	    <div class="post_img small static">
						    	    	<a href="<?php the_permalink(); ?>">
						    	    		<img src="<?php echo esc_url($small_image_url[0]); ?>" alt="<?php echo esc_attr($image_alt); ?>" class=""/>
						                </a>
						    	    </div>
