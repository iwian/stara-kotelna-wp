			    ...
			    switch($post_ft_type)
			    {
			    	...
			    	default:
			        	if(!empty($image_thumb))
			        	{
				        	...
				        	if(has_image_size('grandrestaurant-blog'))
				        	{
					        	$small_image_url = wp_get_attachment_image_src($image_id, 'grandrestaurant-blog', true);
				        	}
				        	//If not fallback to original theme defined size
				        	else
				        	{
					...
					<div class="post_quote_title">
					    ...
					    <div class="post_detail">
							...
							<span class="post_info_comment">
				    	    	<a href="<?php comments_link(); ?>"><?php comments_number(__('No Comment', 'grandrestaurant'), __('1 Comment', 'grandrestaurant'), __('% Comments', 'grandrestaurant')); ?></a>
				        	</span>
...
<?php endwhile; endif; ?>
			...
			<div class="pagination_detail">
		     	...
		     	?>
		     	<?php _e( 'Page', 'grandrestaurant' ); ?> <?php echo esc_html($paged); ?> <?php _e( 'of', 'grandrestaurant' ); ?> <?php echo esc_html($wp_query->max_num_pages); ?>
		     </div>
		     <?php
		     }
		     ?>
