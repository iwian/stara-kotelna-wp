...
$page_postmetas = 
	array (
		...
		*/
		...
		array("section" => "Default Page Menu", "id" => "page_menu_transparent", "type" => "checkbox", "title" => "Make Menu Transparent", "description" => "Check this option if you want to display menu in transparent"),
		
		array("section" => esc_html__('Select Header (Optional)', 'grandrestaurant' ), "id" => "page_header", "type" => "select", "title" => esc_html__('Page Header (Optional)', 'grandrestaurant' ), "description" => esc_html__('Select this page header content if you want to display header content other than default one', 'grandrestaurant' ), "items" => $tg_headers_select),
			
			array("section" => esc_html__('Select Sticky Header (Optional)', 'grandrestaurant' ), "id" => "page_sticky_header", "type" => "select", "title" => esc_html__('Page Sticky Header (Optional)', 'grandrestaurant' ), "description" => esc_html__('Select this page sticky header content if you want to display header content other than default one', 'grandrestaurant' ), "items" => $tg_headers_select),
			
			array("section" => esc_html__('Select Transparent Header (Optional)', 'grandrestaurant' ), "id" => "page_transparent_header", "type" => "select", "title" => esc_html__('Page Transparent Header (Optional)', 'grandrestaurant' ), "description" => esc_html__('Select this page transparent header content if you want to display transparent header content other than default one', 'grandrestaurant' ), "items" => $tg_headers_select),
			...
			array("section" => esc_html__('Select Footer (Optional)', 'grandrestaurant' ), "id" => "page_footer", "type" => "select", "title" => esc_html__('Page Footer (Optional)', 'grandrestaurant' ), "description" => esc_html__('Select this page footer content if you want to display footer content other than default one', 'grandrestaurant' ), "items" => $tg_footers_select),
			
			array("section" => esc_html__('Footer', 'grandrestaurant' ), "id" => "page_hide_footer", "type" => "checkbox", "title" => esc_html__('Hide Footer', 'grandrestaurant' ), "description" => esc_html__('Check this option if you want to hide default page footer', 'grandrestaurant' )),
	);
