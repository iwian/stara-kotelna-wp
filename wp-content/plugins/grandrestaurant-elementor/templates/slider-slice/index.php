	...
	?>
		<section class="slides-nav">
		    <nav class="slides-nav-nav">
		      	<button class="slides-nav__prev js-prev"><?php esc_html_e( 'Prev' , 'grandrestaurant-elementor' ); ?></button>
			  	<button class="slides-nav__next js-next"><?php esc_html_e( 'Next' , 'grandrestaurant-elementor' ); ?></button>
		    </nav>
	  	</section>
	<?php
		}
