						...
						<div class="post-featured-image-hover">
							...
							?>
							 ...
							 <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
								<img <?php echo grandrestaurant_get_blank_img_attr(); ?> <?php echo esc_attr($return_attr['source']); ?>="<?php echo esc_url($blog_featured_img_url); ?>" class="<?php echo esc_attr($return_attr['class']); ?>" alt="<?php echo esc_attr($blog_featured_img_alt); ?>"/>
							 </a>
							 <?php
								 }
							?>
