...
?>
<div class="themegoods-background-menu-wrapper mouseover-effect-<?php echo esc_attr($settings['mouseover_effect']); ?>" display-default="<?php echo esc_attr($settings['display_default']); ?>">
