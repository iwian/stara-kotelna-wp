...
<div class="pricing-plan-switch-wrap">
	<span class="pricing-plan-switch-month"><?php echo __( 'Bill month', 'grandrestaurant-elementor' ); ?></span>
	...
	<span class="pricing-plan-switch-year"><?php echo __( 'Bill yearly', 'grandrestaurant-elementor' ); ?></span>
</div>
<?php
	}
?>
				...
				<div class="overflow-inner">
					<div class="pricing-plan-wrap">
						...
						<div class="pricing-plan-price-wrap">
							...
							<span class="pricing-plan-unit-month">/<?php echo __( 'Month', 'grandrestaurant-elementor' ); ?></span>
							<span class="pricing-plan-unit-year hide">/<?php echo __( 'Year', 'grandrestaurant-elementor' ); ?></span>
						</div>
					</div>
