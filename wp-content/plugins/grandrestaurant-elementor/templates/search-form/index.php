...
<div class="tg-search-wrapper"> 	
	<form id="tg-search-form-<?php echo esc_attr($widget_id); ?>" class="tg-search-form <?php if($settings['autocomplete'] == 'yes') { ?>autocomplete-form<?php } ?>" method="get" action="<?php echo esc_url($redirect_to_page); ?>" data-result="autocomplete-<?php echo esc_attr($widget_id); ?>">
