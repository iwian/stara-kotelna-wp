 ...
 * @since 1.0.0
 */
class GrandRestaurant_Slider_Transitions extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-slider-transitions';
	}
	...
	public function get_title() {
		return __( 'Fullscreen Transitions Slider', 'grandrestaurant-elementor' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'slide_image_left', [
				'label' => __( 'Image Left', 'grandrestaurant-elementor' ),
		...
		$repeater->add_control(
			'slide_image_right', [
				'label' => __( 'Image Right', 'grandrestaurant-elementor' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
				'label_block' => true,
			]
		);
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/slider-transitions/index.php');
	}
