 ...
 * @since 1.0.0
 */
class GrandRestaurant_Portfolio_Grid_overlay extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-portfolio-grid-overlay';
	}
	...
	public function get_title() {
		return __( 'Portfolio Grid Overlay', 'grandrestaurant-elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Overlay Background', 'grandrestaurant-elementor' ),
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/portfolio-grid-overlay/index.php');
	}
