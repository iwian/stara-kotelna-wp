 ...
 * @since 1.0.0
 */
class GrandRestaurant_Slider_Animated_Frame extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-slider-animated-frame';
	}
	...
	public function get_title() {
		return __( 'Animated Frame Slider', 'grandrestaurant-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'imagesloaded', 'anime', 'grandrestaurant-elementor' ];
	}
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/slider-animated-frame/index.php');
	}
