 ...
 * @since 1.0.0
 */
class GrandRestaurant_Flip_Box extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-flip-box';
	}
	...
	public function get_title() {
		return __( 'Flip Box', 'grandrestaurant-elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
		    'default_image',
		    [
		        'label' => __( 'Default Background Image', 'grandrestaurant-elementor' ),
		...
		$this->add_control(
		    'default_icon',
		    [
		        'label' => __( 'Default Icon', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::MEDIA,
		    ]
		);
		...
		$this->add_responsive_control(
		    'icon_max_width',
		    [
		        'label' => __( 'Icon Max Width (in px)', 'grandrestaurant-elementor' ),
		...
		$this->add_control(
		    'default_title',
		    [
		        'label' => __( 'Default Title', 'grandrestaurant-elementor' ),
		...
		$this->add_control(
		    'default_description',
		    [
		        'label' => __( 'Default Description', 'grandrestaurant-elementor' ),
		...
		$this->add_control(
		    'flip_image',
		    [
		        'label' => __( 'Flip Background Image', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::MEDIA,
		    ]
		);
		...
		$this->add_control(
		    'flip_title',
		    [
		        'label' => __( 'Flip Title', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::TEXT,
		    ]
		);
		...
		$this->add_control(
		    'flip_button_title',
		    [
		        'label' => __( 'Flip Button Title', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::TEXT,
		    ]
		);
		...
		$this->add_control(
		    'flip_button_link',
		    [
		        'label' => __( 'Flip Button Link', 'grandrestaurant-elementor' ),
		...
		$this->add_control(
		    'content_bg_color',
		    [
		        'label' => __( 'Overlay Background Color', 'grandrestaurant-elementor' ),
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Default Content', 'grandrestaurant-elementor' ),
		...
		$this->add_control(
		    'default_title_color',
		    [
		        'label' => __( 'Default Title Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Default Title Typography', 'grandrestaurant-elementor' ),
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Default Description Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Default Description Typography', 'grandrestaurant-elementor' ),
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Flip Content', 'grandrestaurant-elementor' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_control(
		    'flip_title_color',
		    [
		        'label' => __( 'Flip Title Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Flip Title Typography', 'grandrestaurant-elementor' ),
		...
		$this->add_control(
		    'button_bg_color',
		    [
		        'label' => __( 'Flip Button Background Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#3d64ff',
		        'selectors' => [
		...
		$this->add_control(
		    'button_font_color',
		    [
		        'label' => __( 'Flip Button Font Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Flip Button Hover Background Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Flip Button Hover Font Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#222222',
		        'selectors' => [
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/flip-box/index.php');
	}
