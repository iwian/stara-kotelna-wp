 ...
 * @since 1.0.0
 */
class GrandRestaurant_Classic_Food_Menu extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-classic-food-menu';
	}
	...
	public function get_title() {
		return __( 'Classic Food Menu', 'grandrestaurant-elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'display_image',
			[
				'label' => __( 'Display Menu Image', 'grandrestaurant-elementor' ),
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '#000000',
		        'selectors' => [
		            '{{WRAPPER}} .menu_content_classic .menu_title' => 'color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .menu_content_classic .menu_title',
			]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '#424242',
		        'selectors' => [
		            '{{WRAPPER}} .post_detail.menu_excerpt' => 'color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .post_detail.menu_excerpt',
			]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '#000000',
		        'selectors' => [
		            '{{WRAPPER}} .menu_content_classic .menu_price' => 'color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .menu_content_classic .menu_price',
			]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '#ffffff',
		        'selectors' => [
		            '{{WRAPPER}} .menu_content_classic .menu_highlight' => 'color: {{VALUE}}',
		            '{{WRAPPER}} .menu_content_classic .menu_order' => 'color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '#cfa670',
		        'selectors' => [
		            '{{WRAPPER}} .menu_content_classic .menu_highlight' => 'background: {{VALUE}}',
		            '{{WRAPPER}} .menu_content_classic .menu_order' => 'background: {{VALUE}}',
		        ],
		    ]
		);
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/classic-food-menu/index.php');
	}
