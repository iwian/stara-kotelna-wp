 ...
 * @since 1.0.0
 */
class GrandRestaurant_Portfolio_Timeline_Vertical extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-portfolio-timeline-vertical';
	}
	...
	public function get_title() {
		return __( 'Portfolio Timeline Vertical', 'grandrestaurant-elementor' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'slide_label', [
				'label' => __( 'Label', 'grandrestaurant-elementor' ),
		...
		$this->add_responsive_control(
		    'title_width',
		    [
		        'label' => __( 'Title Width (in %)', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::SLIDER,
		        'default' => [
		            'size' => 50,
		        ],
		        ...
		        'size_units' => [ '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .portfolio-timeline-vertical-content-wrapper .timeline .swiper-slide-content' => 'width: {{SIZE}}%;',
		        ],
		    ]
		);
		...
		$this->add_control(
		    'nav_color',
		    [
		        'label' => __( 'Navigation Line Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/portfolio-timeline-vertical/index.php');
	}
