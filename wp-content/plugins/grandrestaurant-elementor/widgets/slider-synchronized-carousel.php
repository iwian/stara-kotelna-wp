 ...
 * @since 1.0.0
 */
class GrandRestaurant_Slider_Synchronized_Carousel extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-slider-synchronized-carousel';
	}
	...
	public function get_title() {
		return __( 'Synchronized Carousel Slider', 'grandrestaurant-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'momentum-slider', 'grandrestaurant-elementor' ];
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Number', 'grandrestaurant-elementor' ),
		...
		$this->add_control(
		    'number_color',
		    [
		        'label' => __( 'Number Color', 'grandrestaurant-elementor' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Number Typography', 'grandrestaurant-elementor' ),
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/slider-synchronized-carousel/index.php');
	}
