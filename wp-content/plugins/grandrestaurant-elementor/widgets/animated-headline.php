 ...
 * @since 1.0.0
 */
class GrandRestaurant_Animated_Headline extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-animated-headline';
	}
	...
	public function get_title() {
		return __( 'Animated Headline', 'grandrestaurant-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'animatedheadline', 'grandrestaurant-elementor' ];
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_headline',
			[
				'label' => __( 'Headline', 'grandrestaurant-elementor' ),
			]
		);
		...
		$this->add_control(
			'headline_animation',
			[
				'label' => __( 'Animation', 'grandrestaurant-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'type',
				'options' => [
					'rotate-1'  => __( 'Rotate', 'grandrestaurant-elementor' ),
					'rotate-2'  => __( 'Rotate 2', 'grandrestaurant-elementor' ),
					'rotate-3'  => __( 'Rotate 3', 'grandrestaurant-elementor' ),
					'type'  => __( 'Type', 'grandrestaurant-elementor' ),
					'loading-bar'  => __( 'Loading Bar', 'grandrestaurant-elementor' ),
					'slide'  => __( 'Slide', 'grandrestaurant-elementor' ),
					'clip'  => __( 'Clip', 'grandrestaurant-elementor' ),
					'zoom'  => __( 'Zoom', 'grandrestaurant-elementor' ),
					'scale'  => __( 'Scale', 'grandrestaurant-elementor' ),
					'push'  => __( 'Push', 'grandrestaurant-elementor' ),
				],
			]
		);
		...
		$this->add_control(
			'headline_before',
			[
				'label' => __( 'Before Animated Text', 'grandrestaurant-elementor' ),
		...
		$repeater->add_control(
			'headline_animated_text', [
				'label' => __( 'Text', 'grandrestaurant-elementor' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			'headline_animated',
			[
				'label' => __( 'Animated Text', 'grandrestaurant-elementor' ),
		...
		$this->add_control(
			'headline_after',
			[
				'label' => __( 'After Animated Text', 'grandrestaurant-elementor' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => '',
			]
		);
		...
		$this->add_control(
			'title_html_tag',
			[
				'label' => __( 'HTML Tag', 'grandrestaurant-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'h1',
				'options' => [
					'h1'  => __( 'H1', 'grandrestaurant-elementor' ),
					'h2'  => __( 'H2', 'grandrestaurant-elementor' ),
					'h3'  => __( 'H3', 'grandrestaurant-elementor' ),
					'h4'  => __( 'H4', 'grandrestaurant-elementor' ),
					'h5'  => __( 'H5', 'grandrestaurant-elementor' ),
					'h6'  => __( 'H6', 'grandrestaurant-elementor' ),
					'div'  => __( 'div', 'grandrestaurant-elementor' ),
					'span'  => __( 'span', 'grandrestaurant-elementor' ),
					'p'  => __( 'p', 'grandrestaurant-elementor' ),
				],
			]
		);
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Headline', 'grandrestaurant-elementor' ),
		...
		$this->add_control(
		    'headline_font_color',
		    [
		        'label' => __( 'Text Color', 'grandrestaurant-elementor' ),
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Animated Text Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#000000',
		        'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Animated Text Typography', 'grandrestaurant-elementor' ),
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/animated-headline/index.php');
	}
