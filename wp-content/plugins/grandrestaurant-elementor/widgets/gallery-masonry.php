 ...
 * @since 1.0.0
 */
class GrandRestaurant_Gallery_Masonry extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-gallery-masonry';
	}
	...
	public function get_title() {
		return __( 'Masonry Gallery', 'grandrestaurant-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'tilt', 'masonry', 'grandrestaurant-elementor' ];
	}
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/gallery-masonry/index.php');
	}
