 ...
 * @since 1.0.0
 */
class GrandRestaurant_Distortion_Grid extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-distortion-grid';
	}
	...
	public function get_title() {
		return __( 'Distortion Hover Grid', 'grandrestaurant-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'imagesloaded', 'three', 'tweenmax', 'hover', 'grandrestaurant-elementor' ];
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'slide_image_hover', [
				'label' => __( 'Image on hover', 'grandrestaurant-elementor' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			'slide_excerpt', [
				'label' => __( 'Excerpt', 'grandrestaurant-elementor' ),
		...
		$this->add_control(
		  'theme',
		  [
		     'label'       => __( 'Theme', 'grandrestaurant-elementor' ),
		     'type' => Controls_Manager::SELECT,
		     'default' => 1,
		     'options' => [
			   1 => __( 'Theme 1', 'grandrestaurant-elementor' ),
			   2 => __( 'Theme 2', 'grandrestaurant-elementor' ),
			   3 => __( 'Theme 3', 'grandrestaurant-elementor' ),
			   4 => __( 'Theme 4', 'grandrestaurant-elementor' ),
			   5 => __( 'Theme 5', 'grandrestaurant-elementor' ),
			   6 => __( 'Theme 6', 'grandrestaurant-elementor' ),
			   7 => __( 'Theme 7', 'grandrestaurant-elementor' ),
			   8 => __( 'Theme 8', 'grandrestaurant-elementor' ),
			   9 => __( 'Theme 9', 'grandrestaurant-elementor' ),
			   10 => __( 'Theme 10', 'grandrestaurant-elementor' ),
			],
		  ]
		);
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/distortion-grid/index.php');
	}
