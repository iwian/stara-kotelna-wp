 ...
 * @since 1.0.0
 */
class GrandRestaurant_Gallery_Justified extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-gallery-justified';
	}
	...
	public function get_title() {
		return __( 'Justified Gallery', 'grandrestaurant-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'tilt', 'justifiedGallery', 'grandrestaurant-elementor' ];
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
		    'row_height',
		    [
		        'label' => __( 'Row Height', 'grandrestaurant-elementor' ),
		...
		$this->add_control(
			'justify_last_row',
			[
				'label' => __( 'Justify Last Row', 'grandrestaurant-elementor' ),
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/gallery-justified/index.php');
	}
