 ...
 * @since 1.0.0
 */
class GrandRestaurant_Portfolio_Classic extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-portfolio-classic';
	}
	...
	public function get_title() {
		return __( 'Portfolio Classic', 'grandrestaurant-elementor' );
	}
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/portfolio-classic/index.php');
	}
