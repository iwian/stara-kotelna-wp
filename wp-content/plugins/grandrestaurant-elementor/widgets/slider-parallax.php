 ...
 * @since 1.0.0
 */
class GrandRestaurant_Slider_Parallax extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-slider-parallax';
	}
	...
	public function get_title() {
		return __( 'Parallax Slider', 'grandrestaurant-elementor' );
	}
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/slider-parallax/index.php');
	}
