 ...
 * @since 1.0.0
 */
class GrandRestaurant_Slider_Clip_Path extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-slider-clip-path';
	}
	...
	public function get_title() {
		return __( 'Fullscreen Clip Path Slider', 'grandrestaurant-elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Navigation Arrow Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#999999',
		        'selectors' => [
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/slider-clip-path/index.php');
	}
