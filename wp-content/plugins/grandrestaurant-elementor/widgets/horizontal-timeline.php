 ...
 * @since 1.0.0
 */
class GrandRestaurant_Horizontal_Timeline extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-horizontal-timeline';
	}
	...
	public function get_title() {
		return __( 'Horizontal Timeline', 'grandrestaurant-elementor' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'slide_date', [
				'label' => __( 'Date', 'grandrestaurant-elementor' ),
				'type' => \Elementor\Controls_Manager::DATE_TIME,
				'default' => __( '2018' , 'grandrestaurant-elementor' ),
				'picker_options' => [
					'enableTime' => false,
					'allowInput' => true,
				],
		...
		$repeater->add_control(
			'slide_date_format', [
				'label' => __( 'Display Date Format', 'grandrestaurant-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'Y',
				'options' => [
					 'Y' => __( 'Year Only', 'grandrestaurant-elementor' ),
					 'M' => __( 'Month Only', 'grandrestaurant-elementor' ),
					 'd M' => __( 'Date & Month', 'grandrestaurant-elementor' ),
					 'M Y' => __( 'Month & Year', 'grandrestaurant-elementor' ),
					 'd M Y' => __( 'Date & Month and Year', 'grandrestaurant-elementor' ),
				],
			]
		);
		...
		$this->add_control(
		    'nav_active_color',
		    [
		        'label' => __( 'Navigation Active Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#000000',
		        'selectors' => [
		...
		$this->add_control(
		    'nav_label_color',
		    [
		        'label' => __( 'Navigation Label Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#000000',
		        'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Navigation Label Typography', 'grandrestaurant-elementor' ),
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/horizontal-timeline/index.php');
	}
