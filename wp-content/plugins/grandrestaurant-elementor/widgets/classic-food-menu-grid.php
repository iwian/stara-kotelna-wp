 ...
 * @since 1.0.0
 */
class GrandRestaurant_Classic_Food_Menu_Grid extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-classic-food-menu-grid';
	}
	...
	public function get_title() {
		return __( 'Classic Food Menu Grid', 'grandrestaurant-elementor' );
	}
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/classic-food-menu-grid/index.php');
	}
