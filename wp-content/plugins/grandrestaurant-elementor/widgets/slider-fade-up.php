 ...
 * @since 1.0.0
 */
class GrandRestaurant_Slider_Fade_UP extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-slider-fadeup';
	}
	...
	public function get_title() {
		return __( 'Fade Up Slider', 'grandrestaurant-elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
		    'height',
		    [
		        'label' => __( 'Content Height (in px)', 'grandrestaurant-elementor' ),
		...
		$this->add_responsive_control(
		    'title_content_width',
		    [
		        'label' => __( 'Description Width (in %)', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::SLIDER,
		        'default' => [
		            'size' => 60,
		            'unit' => '%',
		...
		$this->add_responsive_control(
		    ...
		    [
		        'label' => __( 'Navigation Font Size', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::SLIDER,
		        'default' => [
		            'size' => 30,
		        ],
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/slider-fade-up/index.php');
	}
