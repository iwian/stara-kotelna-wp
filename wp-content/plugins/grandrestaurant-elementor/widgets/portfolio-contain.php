 ...
 * @since 1.0.0
 */
class GrandRestaurant_Portfolio_Contain extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-portfolio-contain';
	}
	...
	public function get_title() {
		return __( 'Portfolio Contain', 'grandrestaurant-elementor' );
	}
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/portfolio-contain/index.php');
	}
