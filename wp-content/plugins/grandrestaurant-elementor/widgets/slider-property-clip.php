 ...
 * @since 1.0.0
 */
class GrandRestaurant_Slider_Property_Clip extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-slider-property-clip';
	}
	...
	public function get_title() {
		return __( 'Property Clip Slider', 'grandrestaurant-elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'image_align',
			[
				'label' => __( 'Image Alignment', 'grandrestaurant-elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'left',
			    'options' => [
		...
		$this->add_control(
		  ...
		  [
		     ...
		     'placeholder' => __( 'Title', 'grandrestaurant-elementor' ),
		  ]
		);
		...
		$this->add_control(
		  ...
		  [
		     ...
		     'type'        => Controls_Manager::TEXT,
		     'placeholder' => __( 'Sub Title', 'grandrestaurant-elementor' ),
		  ]
		);
		...
		$this->add_control(
		  ...
		  [
		     ...
		     'default' => __( 'Default description', 'grandrestaurant-elementor' ),
		  ]
		);
		...
		$this->add_control(
		    'content_background',
		    [
		        'label' => __( 'Content Background', 'grandrestaurant-elementor' ),
		...
		$this->add_control(
		    'pagination_color',
		    [
		        'label' => __( 'Pagination Background Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/slider-property-clip/index.php');
	}
