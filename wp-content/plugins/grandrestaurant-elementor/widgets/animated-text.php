 ...
 * @since 1.0.0
 */
class GrandRestaurant_Animated_Text extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-animated-text';
	}
	...
	public function get_title() {
		return __( 'Animated Text', 'grandrestaurant-elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'rows' => 5,
				'default' => '',
				'placeholder' => __( 'Type your title here', 'grandrestaurant-elementor' ),
			]
		);
		...
		$this->add_control(
			'title_link',
			[
				'label' => __( 'Link', 'grandrestaurant-elementor' ),
				'type' => \Elementor\Controls_Manager::URL,
				'placeholder' => __( 'Paste URL or type', 'grandrestaurant-elementor' ),
				'show_external' => true,
				'default' => [
					'url' => '',
					'is_external' => true,
		...
		$this->add_control(
			...
			[
				'label' => __( 'Delimiter Type', 'grandrestaurant-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'word',
				'options' => [
					'character'  => __( 'Character', 'grandrestaurant-elementor' ),
					'word'  => __( 'Word', 'grandrestaurant-elementor' ),
					'sentence'  => __( 'Sentence', 'grandrestaurant-elementor' ),
				],
			]
		);
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Transition Duration (in milli-seconds)', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::SLIDER,
		        'default' => [
		            'size' => 800,
		        ],
		...
		$this->add_control(
			...
			[
				'label' => __( 'Transition from', 'grandrestaurant-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'right',
				'options' => [
					'left'  => __( 'Left', 'grandrestaurant-elementor' ),
					'right'  => __( 'Right', 'grandrestaurant-elementor' ),
					'top'  => __( 'Top', 'grandrestaurant-elementor' ),
					'bottom'  => __( 'Bottom', 'grandrestaurant-elementor' ),
					'zoomin'  => __( 'Zoom In', 'grandrestaurant-elementor' ),
					'zoomout'  => __( 'Zoom Out', 'grandrestaurant-elementor' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Transition Overflow', 'grandrestaurant-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'visible',
				'options' => [
					'visible'  => __( 'Visible', 'grandrestaurant-elementor' ),
					'hidden'  => __( 'Hidden', 'grandrestaurant-elementor' ),
				],
			]
		);
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/animated-text/index.php');
	}
