 ...
 * @since 1.0.0
 */
class GrandRestaurant_Mouse_Drive_Vertical_Carousel extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-mouse-driven-vertical-carousel';
	}
	...
	public function get_title() {
		return __( 'Mouse Driven Vertical Carousel', 'grandrestaurant-elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
		    'header',
		    [
		        'label' => __( 'Header', 'grandrestaurant-elementor' ),
		...
		$this->add_control(
		    'sub_header',
		    [
		        'label' => __( 'Sub Header', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::TEXT,
		    ]
		);
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Header & Sub Header', 'grandrestaurant-elementor' ),
		...
		$this->add_control(
		    'header_color',
		    [
		        'label' => __( 'Header Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Header Typography', 'grandrestaurant-elementor' ),
		...
		$this->add_control(
		    'sub_header_color',
		    [
		        'label' => __( 'Sub Header Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Sub Header Typography', 'grandrestaurant-elementor' ),
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/mouse-driven-vertical-carousel/index.php');
	}
