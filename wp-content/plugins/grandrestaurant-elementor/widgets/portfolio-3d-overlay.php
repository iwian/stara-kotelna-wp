 ...
 * @since 1.0.0
 */
class GrandRestaurant_Portfolio_3D_overlay extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-portfolio-3d-overlay';
	}
	...
	public function get_title() {
		return __( 'Portfolio 3D Overlay', 'grandrestaurant-elementor' );
	}
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/portfolio-3d-overlay/index.php');
	}
