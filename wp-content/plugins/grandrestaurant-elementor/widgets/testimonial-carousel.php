 ...
 * @since 1.0.0
 */
class GrandRestaurant_Testimonial_Carousel extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-testimonial-carousel';
	}
	...
	public function get_title() {
		return __( 'Testimonial Carousel', 'grandrestaurant-elementor' );
	}
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/testimonial-carousel/index.php');
	}
