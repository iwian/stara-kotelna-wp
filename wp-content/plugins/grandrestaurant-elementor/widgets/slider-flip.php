 ...
 * @since 1.0.0
 */
class GrandRestaurant_Slider_Flip extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-slider-flip';
	}
	...
	public function get_title() {
		return __( 'Flip Slider', 'grandrestaurant-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'mousewheel', 'grandrestaurant-elementor' ];
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
		    'slide_width',
		    [
		        'label' => __( 'Slide Width', 'grandrestaurant-elementor' ),
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/slider-flip/index.php');
	}
