 ...
 * @since 1.0.0
 */
class GrandRestaurant_Pricing_Table extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-pricing-table';
	}
	...
	public function get_title() {
		return __( 'Pricing Table', 'grandrestaurant-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'switchery', 'grandrestaurant-elementor' ];
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'slide_price_month', [
				'label' => __( 'Price/Month', 'grandrestaurant-elementor' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'label_block' => true,
				'default' => __( '$10' , 'grandrestaurant-elementor' ),
			]
		);
		
		$repeater->add_control(
			'slide_price_year', [
				'label' => __( 'Price/Year', 'grandrestaurant-elementor' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'label_block' => true,
				'default' => __( '$99' , 'grandrestaurant-elementor' ),
			]
		);
		
		$repeater->add_control(
			'slide_features', [
				'label' => __( 'Features', 'grandrestaurant-elementor' ),
				'description' => __( 'Enter each feature seperate by enter (new line)', 'grandrestaurant-elementor' ),
		...
		$repeater->add_control(
			'slide_button_title', [
				'label' => __( 'Button Title', 'grandrestaurant-elementor' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			'slide_button_link', [
				'label' => __( 'Button Link URL', 'grandrestaurant-elementor' ),
		...
		$repeater->add_control(
			'slide_featured', [
				'label' => __( 'Mark as Featured Plan', 'grandrestaurant-elementor' ),
		...
		$this->add_control(
			'slides',
			[
				'label' => __( 'Plans', 'grandrestaurant-elementor' ),
		...
		$this->add_control(
			'price_switching',
			[
				'label' => __( 'Price Switching', 'grandrestaurant-elementor' ),
		...
		/*$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .pricing-table-wrapper .inner-wrap' => 'border-radius: {{SIZE}}{{UNIT}};',
				],
			]
		);*/
		...
		$this->start_controls_section(
			'section_plan_style',
			array(
				'label'      => esc_html__( 'Plan', 'grandrestaurant-elementor' ),
		...
		$this->add_responsive_control(
		    'plan_padding',
		    [
		        'label' => __( 'Plan Content Padding', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::SLIDER,
		        'default' => [
		            'size' => 60,
		            'unit' => 'px',
		...
		$this->add_control(
		    'plan_bg_color',
		    [
		        'label' => __( 'Plan Background Color', 'grandrestaurant-elementor' ),
		...
		$this->add_control(
		    'plan_border_color',
		    [
		        'label' => __( 'Plan Border Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		            '{{WRAPPER}} .pricing-table-wrapper .inner-wrap' => 'border-color: {{VALUE}}',
		            '{{WRAPPER}} .pricing-table-wrapper .inner-wrap .overflow-inner' => 'border-color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_control(
		    'plan_hover_bg_color',
		    [
		        'label' => __( 'Plan Hover Background Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Plan Hover Border Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#000000',
		        'selectors' => [
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Featured Plan Background Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Featured Plan Border Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#000000',
		        'selectors' => [
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Featured Plan Title Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#000000',
		        'selectors' => [
		...
		$this->add_control(
		    'price_hover_color',
		    [
		        'label' => __( 'Price Hover Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#000000',
		        'selectors' => [
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Featured Plan Price Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#000000',
		        'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Price per Typography', 'grandrestaurant-elementor' ),
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Features', 'grandrestaurant-elementor' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_control(
		    'features_color',
		    [
		        'label' => __( 'Features Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#000000',
		        'selectors' => [
		...
		$this->add_control(
		    'features_icon_color',
		    [
		        'label' => __( 'Check Icon Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#000000',
		        'selectors' => [
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Features Hover Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#000000',
		        'selectors' => [
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Featured Plan Features Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#000000',
		        'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Features Typography', 'grandrestaurant-elementor' ),
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Switching', 'grandrestaurant-elementor' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Switching Button Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#000000',
		    ]
		);
		...
		$this->add_control(
		    'switching_bg_color',
		    [
		        'label' => __( 'Switching Background Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#E7E7E7',
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Switching Font Color', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#000000',
		        'selectors' => [
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/pricing-table/index.php');
	}
