 ...
 * @since 1.0.0
 */
class GrandRestaurant_Slider_Zoom extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-slider-zoom';
	}
	...
	public function get_title() {
		return __( 'Zoom Slider', 'grandrestaurant-elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
		    'title_margintop',
		    [
		        'label' => __( 'Title Margin Top (in px)', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::SLIDER,
		        'default' => [
		            'size' => 45,
		        ],
		...
		$this->add_control(
		    'overlay_background',
		    [
		        'label' => __( 'Overlay Background', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#0000000',
		        'selectors' => [
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/slider-zoom/index.php');
	}
