 ...
 * @since 1.0.0
 */
class GrandRestaurant_Service_Grid extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-service-grid';
	}
	...
	public function get_title() {
		return __( 'Service Grid', 'grandrestaurant-elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
		    'height',
		    [
		        'label' => __( 'Grid Height (in px)', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::SLIDER,
		        'default' => [
		            'size' => 350,
		        ],
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Hover Background', 'grandrestaurant-elementor' ),
		...
		$this->add_responsive_control(
		    'icon_size',
		    [
		        'label' => __( 'Icon Size (in px)', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::SLIDER,
		        'default' => [
		            'size' => 30,
		        ],
		...
		$this->add_control(
			...
			[
				...
				'toggle' => true,
				'selectors' => [
					'{{WRAPPER}} .service-grid-wrapper .overflow-inner .header-wrap' => 'text-align: {{VALUE}}',
					'{{WRAPPER}} .service-grid-wrapper .overflow-inner .hover-content' => 'text-align: {{VALUE}}',
				],
			]
		);
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/service-grid/index.php');
	}
