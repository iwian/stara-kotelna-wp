 ...
 * @since 1.0.0
 */
class GrandRestaurant_Background_List extends Widget_Base {
	...
	public function get_name() {
		return 'grandrestaurant-background-list';
	}
	...
	public function get_title() {
		return __( 'Background List', 'grandrestaurant-elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'slides',
			[
				'label' => __( 'Slides (Max. 4)', 'grandrestaurant-elementor' ),
		...
		$this->add_control(
		    'transition',
		    [
		        'label' => __( 'Transition (in milliseconds)', 'grandrestaurant-elementor' ),
		        'type' => Controls_Manager::SLIDER,
		        'default' => [
		            'size' => 500,
		        ],
	...
	protected function render() {
		include(GRANDRESTAURANT_ELEMENTOR_PATH.'templates/background-list/index.php');
	}
